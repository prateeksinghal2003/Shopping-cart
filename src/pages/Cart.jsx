// jo jo items select karunga add to cart vale page main vo appear hongi
...
//   We write cart.reduce in this code because reduce() is a powerful JavaScript method used to process arrays, 
//   and the cart is an array of objects (likely representing items in a shopping cart).
...
// }, initialValue);
  ...
  //setTotalAmount gets call whenever cart array changes
  ...
  <div >
    {
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
          ...
          <div className="flex flex-col p-5 gap-5 my-14  h-[100%] justify-between">
            ...
            {/* in a string if i want to insert a variable use ${}
            otherwise {} only */}
